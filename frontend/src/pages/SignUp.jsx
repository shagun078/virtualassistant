...
function SignUp() {
  ...
  return (
    ...
    >
      <form
        className="w-[90%] h-[600px] max-w-[500px] bg-[#00000052] backdrop-blur rounded-lg flex flex-col justify-center items-center gap-[20px] px-[20px]"
      ...
      >
        ...
        <div className="relative w-full h-[60px] border-2 border-white bg-transparent text-white rounded-full text-[18px]">
          <input
            ...
            className="w-full h-full outline-none bg-transparent text-white placeholder-gray-300 px-[20px] rounded-full py-[10px]"
            required
        ...
        <button
          className="min-w-[150px] h-[60px] bg-white rounded-3xl text-black font-semibold text-[19px] mt-[26px]"
          disabled={loading}
        >
